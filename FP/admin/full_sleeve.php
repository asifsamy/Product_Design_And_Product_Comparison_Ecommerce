...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="js/tshirtEditor2.js"></script>
    ...
    <div class="container">
		<section id="typography">
		  <div class="page-header">
		    <h1>Customize Full-Sleeve T-Shirt</h1>
		  </div>
		    ...
		    <div class="span3">
		    	...
		    	<div class="tabbable"> <!-- Only required for left/right tabs -->
				  <ul class="nav nav-tabs">
				  	<li class="active"><a href="#tab1" data-toggle="tab">Choose Color</a></li>				    
		    ...
		    <div class="span6">		    
				...
				<!--	EDITOR      -->					
					<div id="shirtDiv" class="page" style="width: 530px; height: 630px; position: relative; background-color: rgb(255, 255, 255);">
						<img id="tshirtFacing" src="img/full_sleeve_front.png"></img>
		      ...
		      <div class="well">
			      ...
			      <p>
			      	<table class="table">
			      		<tr>
			      			<td>Full Sleeve</td>
			      			<td align="right">TK. 300.00</td>
			      		</tr>
			      		<tr>
			      			<td>Design</td>
			      			<td align="right">TK. 150.00</td>
			      		</tr>
			      		<tr>
			      			<td><strong>Total</strong></td>
			      			<td align="right"><strong>TK. 450.00</strong></td>
			      		</tr>
			      	</table>			
			      </p>
					<a href="save_image2.php" type="button" class="btn btn-large btn-block btn-success" name="addToTheBag" id="addToTheBag">Add to bag <i class="icon-briefcase icon-white"></i></a>
