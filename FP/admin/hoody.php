...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="js/tshirtEditor3.js"></script>
    ...
    <div class="container">
		<section id="typography">
		  <div class="page-header">
		    <h1>Customize Half-Sleeve T-Shirt</h1>
		  </div>
		    ...
		    <div class="span6">		    
				...
				<!--	EDITOR      -->					
					<div id="shirtDiv" class="page" style="width: 530px; height: 630px; position: relative; background-color: rgb(255, 255, 255);">
						<img id="tshirtFacing" src="img/mens_hoodie_front.png"></img>
			      ...
			      <p>
			      	<table class="table">
			      		...
			      		<tr>
			      			...
			      			<td align="right"><strong>TK. 350.00</strong></td>
			      		</tr>
			      	</table>			
			      </p>
					<a href="save_image.php" type="button" class="btn btn-large btn-block btn-success" name="addToTheBag" id="addToTheBag">Add to bag <i class="icon-briefcase icon-white"></i></a>
