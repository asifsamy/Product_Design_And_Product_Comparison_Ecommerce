...
<div id="welcomeLine" class="row">
	<div class="span6">
		...
		<input id="" class="srchTxt" type="text" name="input" required />
...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
   ...
   <li class=""><a href="../index.php">Home</a></li>
	 <li class=""><a href="half_sleeve.php">Half Sleeve</a></li>
   <!--<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Page 1 <span class="caret"></span></a>
	 ...
	 <li class=""><a href="full_sleeve.php">Full Sleeve</a></li>
	 <li class=""><a href="hoody.php">Hoody</a></li>
<?php
      $cmrId = Session::get("cmrId"); 
      $chkOrder = $od->checkOrder($cmrId);
      if ($chkOrder) { ?>
