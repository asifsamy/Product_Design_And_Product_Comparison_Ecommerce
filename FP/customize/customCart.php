                ...
                <tr>
					...
					<td>
						<form action="" method="post" class="form-horizontal qtyFrm">
							...
							<input onclick="return success('Quantity Updated Successfully')" class="btn btn-primary" type="submit" name="submit" value="Update"/>
						</form>
					</td>
					<td>Tk. <?php
	...
	<div class="shopping">
		<table>
			<tr>
				<td>
					<div class="shopleft">
			           <a href="index.php"> <img src="themes/images/shop.png" alt="" /></a>
		            </div>
				</td>
				<td>
					<div class="shopright pull-right">
			           <a href="payment.php"> <img src="themes/images/check.png" alt="" /></a>
		            </div>
				</td>
			</tr>
		</table>
